...
<?php
   ...
   $Ord_Cmp = new grid_end_OAR_history_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_end_OAR_history_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['staff_user'] = "staff_user";
   $tab_labels["staff_user"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['labels']["staff_user"])) ? $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['labels']["staff_user"] : "" . $this->Nm_lang['lang_end_OAR_history_fld_staff_user'] . "";
   $tab_ger_campos['matriz_id'] = "on";
   $tab_def_campos['matriz_id'] = "matriz_id";
   $tab_labels["matriz_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['labels']["matriz_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['labels']["matriz_id"] : "" . $this->Nm_lang['lang_end_OAR_history_fld_matriz_id'] . "";
   $tab_ger_campos['upload_date'] = "on";
   $tab_def_campos['upload_date'] = "upload_date";
   $tab_labels["upload_date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['labels']["upload_date"])) ? $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['labels']["upload_date"] : "" . $this->Nm_lang['lang_end_OAR_history_fld_upload_date'] . "";
   $tab_ger_campos['remark'] = "on";
   $tab_def_campos['remark'] = "remark";
   $tab_labels["remark"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['labels']["remark"])) ? $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['labels']["remark"] : "Remark";
   $tab_ger_campos['timestamp'] = "on";
   $tab_def_campos['timestamp'] = "timestamp";
   $tab_labels["timestamp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['labels']["timestamp"])) ? $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['labels']["timestamp"] : "Timestamp";
   $tab_ger_campos['login'] = "on";
   $tab_def_campos['login'] = "login";
   $tab_labels["login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['labels']["login"])) ? $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['labels']["login"] : "Login";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_end_OAR_history_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_end_OAR_history']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
