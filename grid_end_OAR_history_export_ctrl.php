<?php
@session_start() ;
$_SESSION['scriptcase']['grid_end_OAR_history']['sc_process_barr'] = true;
require_once('../grid_end_OAR_history/index.php');
unset($_SESSION['scriptcase']['grid_end_OAR_history']['sc_process_barr']);
$ExportCtrl = new grid_end_OAR_history_export_control;
$ExportCtrl->Export_barr();

class grid_end_OAR_history_export_control
{
