...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["GMCP_IOW_____grid_end_OAR_history"]))
   {
      unset($_SESSION['session_sec_aplicacao']["GMCP_IOW_____grid_end_OAR_history"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_end_OAR_history_Update'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_end_OAR_history']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_end_OAR_history']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_end_OAR_history']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_end_OAR_history']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_end_OAR_history']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_end_OAR_history</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_end_OAR_history']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_end_OAR_history']['embutida_filho'] as $ind => $sc_init)
          {
