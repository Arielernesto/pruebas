...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "upload_date";$Nm_datas[] = "timestamp";$Nm_numeric[] = "id_eoar_pdf";$Nm_numeric[] = "matriz_id";$Nm_numeric[] = "staff_user";$Nm_numeric[] = "mentor_id";
...
<span class="scFilterLabelOdd scFilterLabelAboveOdd"><span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_remark_cond" name="remark_cond" onChange="nm_campos_between(document.getElementById('id_vis_remark'), this, 'remark')">
       <OPTION value="qp" <?php if ("qp" == $remark_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_remark"  <?php echo $str_hide_remark?>><INPUT  type="text" id="SC_remark" name="remark" value="<?php echo NM_encode_input($remark) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
